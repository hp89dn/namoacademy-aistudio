...
export const CreateApiPanel: React.FC<any> = ({
    ...
    imageSize, setImageSize, aiModel,
                ...
                {sourceImage ? (
                  <div className='space-y-3'>
                      ...
                      <button 
                          ...
                          className='w-full text-red-400 hover:text-red-500 text-xs font-bold px-3 py-2 rounded-md hover:bg-red-500/10 border border-red-500/20 uppercase tracking-widest'
                      >
                          {t('delete')}
                      </button>
                  </div>
            ...
            <section>
                ...
                <div className="mt-3 grid grid-cols-1 sm:grid-cols-2 gap-2">
                    ...
                    <button 
                        ...
                        className={`col-span-full w-full flex items-center justify-center gap-2 font-semibold py-2.5 px-4 rounded-lg ${theme.buttonSecondary} disabled:opacity-50 disabled:cursor-not-allowed`}
                    >
